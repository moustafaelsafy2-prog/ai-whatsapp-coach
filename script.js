...
function initUIEnhancements() {
  ...
  // ربط التمدد بعد الإرسال
  if (window.App && App.core && typeof App.core.sendMessage === 'function') {
...
const App = {
  ...
  i18n: {
    strings: {
      ar: {
        ...
        welcomeSubtitle: 'جاهز للتغيير؟ خطتك مصممة خصصًا لك — تنفيذ محكم، متابعة دقيقة، ونتيجة ملموسة.',
        startButtonText: 'ابدأ الآن',
        userDataTitle: 'لنبني ملفك السريع',
        userDataSubtitle: 'نحتاج بعض المعلومات للبدء',
        namePlaceholder: 'اكتب اسمك هنا',
        agePlaceholder: 'عمرك',
        countryPlaceholder: 'بلدك',
        nextButtonText: 'ابدأ المحادثة',
        inputPlaceholder: 'اكتب رسالتك...',
        emptyFields: 'الرجاء إدخال اسمك وعمرك وبلدك للمتابعة.',
        imageUpload: 'تم استلام الصورة — يتم التحليل الآن.',
        maxImagesReached: 'يا بطل، تقدر ترفع 5 صور بس في المرة الواحدة.',
        typing: '…',
        recStart: '● جاري التسجيل… ارفع إصبعك للإرسال',
        recDenied: 'تعذّر الوصول للميكروفوون.',
        recTooShort: 'التسجيل قصير جدًا.',
        recSaved: 'تم نسخ الكلام إلى خانة الكتابة.',
        ctaTitle: 'جاهز لنتيجة ملموسة؟',
        ctaSubtitle: 'خطة مُحكمة + متابعة أسبوعية.',
        getPlanButton: 'احصل على خطتك الآن',
        contactModalTitle: 'احصل على خطتك الآن',
        contactModalText1: 'اختر الطريقة المناسبة للتواصل المباشر مع المدرب.',
        whatsappBtnText: 'واتساب',
        phoneBtnText: 'اتصال',
        copied: 'تم النسخ!',
        iherbTitle: 'احصل على مكملاتك من iHerb',
        iherbSubtitle: 'خصم إضافي 10% هدية من مدربك!',
        copyAndGoButton: 'اذهب للمتجر',
        iherbCopiedAndRedirecting: 'تم نسخ الكود! يتم الآن تحويلك...',
        coffeeText: 'هل أعجبتك الأداة؟ دعمك يساعدنا على الاستمرار.',
        coffeeBtnText: 'ادعمني بقهوة',
        coffeeBtnText2: 'ادعمني بقهوة',
        imageAttached: '[صور مرفقة]',
        resetTitle: 'ابدأ من جديد',
        resetModalTitle: 'تأكيد الحذف',
        resetModalText: 'هل أنت متأكد أنك تريد حذف كل الرسائل والبدء من جديد؟',
        resetCancelBtn: 'إلغاء',
        resetConfirmBtn: 'موافق',
        contextCopy: 'نسخ',
        contextShare: 'مشاركة',
        contextPin: 'تثبيت',
        contextUnpin: 'إلغاء التثبيت',
        contextEdit: 'تعديل',
        contextDelete: 'حذف',
        ...
        profileName: 'الكابتن مصطفى الصافي',
        profilePhone: '',
        profileBioTitle: 'عني',
        profileBioText:
          'شغفي هو هندسة الأجسام والعقول. كخبير دولي معتمد من كاليفورنيا، أدمج أحدث علوم اللياقة والتغذية مع فهم عميق لأسلوب حياتك، لأصنع لك تحولاً حقيقياً ومستداماً. مهمتي ليست مجرد خطة، بل بناء نظام حياة يطلق أفضل نسخة منك.',
        ...
        welcomeMessage:
          'أهلًا بيك يا {name}، معاك مساعد المدرب الدولي مصطفى الصافي. جاهز نبدأ رحلتك؟ إيه هدفك الأساسي؟'
      },
      en: {
        appName: 'Smart Personal Coach',
        welcomeSubtitle:
          'Ready for a change? Your plan is tailored for you—precise execution, close follow-up, and tangible results.',
        startButtonText: 'Start Now',
        userDataTitle: "Let's build your quick profile",
        userDataSubtitle: 'We need some information to get started',
        namePlaceholder: 'Your Name',
        agePlaceholder: 'Your Age',
        countryPlaceholder: 'Your Country',
        nextButtonText: 'Start Conversation',
        inputPlaceholder: 'Type your message…',
        emptyFields: 'Please enter your name, age, and country to continue.',
        imageUpload: 'Image received — analyzing now.',
        maxImagesReached: 'Heads up! You can only upload 5 images at a time.',
        typing: '…',
        recStart: '● Recording… release to send',
        recDenied: 'Microphone access denied.',
        recTooShort: 'Recording is too short.',
        recSaved: 'Text copied to input.',
        ctaTitle: 'Ready for tangible results?',
        ctaSubtitle: 'Precise plan + weekly follow-up.',
        getPlanButton: 'Get Your Plan Now',
        contactModalTitle: 'Get your plan now',
        contactModalText1: 'Choose the best way to contact the coach directly.',
        whatsappBtnText: 'WhatsApp',
        phoneBtnText: 'Call',
        copied: 'Copied!',
        iherbTitle: 'Get your supplements from iHerb',
        iherbSubtitle: "An extra 10% discount, a gift from your coach!",
        copyAndGoButton: 'Go to Store',
        iherbCopiedAndRedirecting: 'Code copied! Redirecting...',
        coffeeText: 'Did you like this free tool? Your support helps us to continue.',
        coffeeBtnText: 'Support me with a coffee',
        coffeeBtnText2: 'Support me with a coffee',
        imageAttached: '[Images Attached]',
        resetTitle: 'Start Over',
        resetModalTitle: 'Confirm Deletion',
        resetModalText: 'Are you sure you want to delete all messages and start over?',
        ...
        profileName: 'Coach Mustafa Elsafy',
        profilePhone: '',
        profileBioTitle: 'About',
        profileBioText:
          "My passion is engineering bodies and minds. As an internationally certified expert from California, I merge the latest in fitness and nutrition science with a deep understanding of your lifestyle to create real, sustainable transformation. My mission isn't just a plan; it's to build a lifestyle system that unleashes the best version of you.",
        ...
        welcomeMessage:
          "Welcome, {name}! I'm assistant to international coach Mustafa Elsafy. Ready to start your journey? What's your main goal?"
      }
    },
    setLang(lang) {
      App.state.lang = lang;
      ...
      updateText('welcomeTitle', 'appName');
      updateText('welcomeSubtitle', 'welcomeSubtitle');
      updateText('startBtn', 'startButtonText');
      updateText('userDataTitle', 'userDataTitle');
      updateText('userDataSubtitle', 'userDataSubtitle');
      updatePlaceholder('userName', 'namePlaceholder');
      updatePlaceholder('userAge', 'agePlaceholder');
      updatePlaceholder('userCountry', 'countryPlaceholder');
      updateText('nextBtn', 'nextButtonText');
      updateText('chatTitle', 'appName');
      updatePlaceholder('userInput', 'inputPlaceholder');
      updateText('contactModalTitle', 'contactModalTitle');
      updateText('contactModalText1', 'contactModalText1');
      updateText('whatsappBtnText', 'whatsappBtnText');
      updateText('phoneBtnText', 'phoneBtnText');
      updateText('coffeeText', 'coffeeText');
      updateText('coffeeBtnText', 'coffeeBtnText');
      updateText('coffeeBtnText2', 'coffeeBtnText2');
      updateText('ctaTitle', 'ctaTitle');
      updateText('ctaSubtitle', 'ctaSubtitle');
      updateText('generatePlanBtn', 'getPlanButton');
      updateText('iherbTitle', 'iherbTitle');
      updateText('iherbSubtitle', 'iherbSubtitle');
      ...
      updateText('resetModalText', 'resetModalText');
      updateText('cancelResetBtn', 'resetCancelBtn');
      updateText('confirmResetBtn', 'resetConfirmBtn');
      updateText('contextCopy', 'contextCopy');
      updateText('contextShare', 'contextShare');
      updateText('contextPin', 'contextPin');
      updateText('contextEdit', 'contextEdit');
      updateText('contextDelete', 'contextDelete');
      updateTitle('unpinBtn', 'unpinTitle');
      updateText('profileName', 'profileName');
      updateText('profilePhone', 'profilePhone');
      updateText('profileBioTitle', 'profileBioTitle');
      updateText('profileBioText', 'profileBioText');
    ...
    autoSetByText(s) {
      ...
      if ((isArabic ? 'ar' : 'en') !== App.state.lang) {
        this.setLang(isArabic ? 'ar' : 'en');
      }
    }
  },
  utils: {
    setTheme() {
      ...
      App.elements.btnTheme && (App.elements.btnTheme.textContent = isDark ? '🌙' : '☀️');
    ...
    formatTime(timestamp) {
      return new Date(timestamp).toLocaleTimeString(App.state.lang === 'ar' ? 'ar-EG' : 'en-US',
  ...
  ui: {
    displayMessage(message) {
      ...
      if (safeContent) {
        finalHtml += `<div class="msg-content">${typeof marked !== 'undefined' ? marked.parse(safeContent) : safeContent}</div>`;
      }
    ...
    setLoading(isLoading) {
      ...
      if (isLoading) {
        if (sendBtn) sendBtn.innerHTML = `<div class="w-5 h-5 border-2 border-white/50 border-t-white rounded-full animate-spin"></div>`;
      } else {
    ...
    speech: {
      ...
      startLocalRecognition() {
        ...
        rec.onresult = (e) => {
          ...
          if (text && App.elements.userInput) {
      ...
      async startRecording() {
        ...
        App.elements.micBtn && App.elements.micBtn.classList.add('mic-live');
        App.elements.recHintWrap && App.elements.recHintWrap.classList.remove('hidden');
        App.elements.recHint && (App.elements.recHint.textContent = L.recStart);
      },
      stopRecording() {
        if (!App.state.isRecording) return;
        App.state.isRecording = false;
        if (App.state.recognition && App.state.recognition.stop) {
          try { App.state.recognition.stop(); App.core.sendMessage(); } catch (_) {}
          App.state.recognition = null;
        }
        App.elements.micBtn && App.elements.micBtn.classList.remove('mic-live');
        App.elements.recHintWrap && App.elements.recHintWrap.classList.add('hidden');
...
• تسويق ذكي غير مزعج: الكود AYT3413 يُذكر مرة واحدة فقط في التوقيت المناسب.`;
  ...
  core: {
        ...
        try {
          ...
          if (sessionData.chatHistory && sessionData.userState) {
            ...
            if (App.state.userState.step > 0) {
              App.elements.welcomeScreen && App.elements.welcomeScreen.classList.add('hidden');
              App.elements.userDataScreen && App.elements.userDataScreen.classList.add('hidden');
              App.elements.chatContainer && App.elements.chatContainer.classList.remove('hidden');
    ...
    sendMessage() {
      const msg = (App.elements.userInput && App.elements.userInput.value || '').trim();
      ...
      if (App.elements.userInput) App.elements.userInput.value = '';
  ...
  handlers: {
    handleStartClick() {
      App.elements.welcomeScreen && App.elements.welcomeScreen.classList.add('hidden');
      App.elements.userDataScreen && App.elements.userDataScreen.classList.remove('hidden');
      App.i18n.setLang(App.state.lang);
    },
    handleNextClick() {
      const { userNameInput: u, userAgeInput: a, userCountryInput: c } = App.elements;
      const n = u && u.value.trim(), g = a && a.value.trim(), o = c && c.value.trim();
    ...
    handleViewImage(dataUrl) {
      if (!App.elements.imageViewerModal || !App.elements.fullImageView) return;
      App.elements.fullImageView.src = dataUrl;
      App.elements.imageViewerModal.classList.add('open');
    },
    closeImageViewer() { App.elements.imageViewerModal && App.elements.imageViewerModal.classList.remove('open'); },
    ...
    openContactModal() {
      if (!App.elements.contactModal) return;
    ...
    handleIherbCodeClick() {
      if (!App.elements.iherbCode) return;
    ...
    openProfileModal() {
      if (!App.elements.profileModal) return;
    ...
    handleResetClick() { App.elements.resetConfirmModal && App.elements.resetConfirmModal.classList.add('open'); },
    handleResetConfirm() { localStorage.removeItem(App.config.STORAGE_KEY); window.location.reload(); },
    handleResetCancel() { App.elements.resetConfirmModal && App.elements.resetConfirmModal.classList.remove('open'); },
    openHowToUseModal() { App.elements.howToUseModal && App.elements.howToUseModal.classList.add('open'); },
    closeHowToUseModal() { App.elements.howToUseModal && App.elements.howToUseModal.classList.remove('open'); },
    handleModalClick(e) {
    ...
    showContextMenu(bubble) {
      ...
      const L = App.i18n.strings[App.state.lang];
      const pinSpan = messageContextMenu.querySelector('[data-action="pin"] span');
    ...
    hideContextMenu() {
      App.elements.messageContextMenu && App.elements.messageContextMenu.classList.remove('show');
    ...
    handleContextMenuAction(action) {
      ...
      if (action === 'copy') {
        navigator.clipboard.writeText(textContent).then(() => App.utils.toast(L.copied));
      } else if (action === 'share') {
        if (navigator.share) {
          navigator.share({ text: textContent }).then(() => App.utils.toast(L.sharedSuccessfully)).catch(() => App.utils.toast(L.shareFailed));
        } else { App.utils.toast(L.shareFailed); }
      } else if (action === 'pin') {
        App.state.pinnedMessageId = (App.state.pinnedMessageId === message.id) ? null : message.id;
        App.core.saveHistory();
        App.ui.updatePinnedMessageUI();
      } else if (action === 'edit') {
        this.handleStartEdit(message);
    ...
    handleStartEdit(message) {
      ...
      if (!msgContentDiv || !userInput) return;
  ...
  init: function () {
    const setup = () => {
      ...
      if (savedTheme === 'dark' || (!savedTheme && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
        ...
        this.elements.btnTheme && (this.elements.btnTheme.textContent = '🌙');
      }

      this.i18n.setLang(navigator.language && navigator.language.startsWith('ar') ? 'ar' : 'en');
      this.core.loadHistory();

      const { elements: E, handlers: H } = this;

      E.startBtn && E.startBtn.addEventListener('click', H.handleStartClick);
      E.nextBtn && E.nextBtn.addEventListener('click', () => H.handleNextClick.call(App));
      E.sendBtn && E.sendBtn.addEventListener('click', () => App.core.sendMessage.call(App.core));
      E.userInput && E.userInput.addEventListener('keypress', H.handleKeyPress);

      E.btnTheme && E.btnTheme.addEventListener('click', this.utils.setTheme);
      E.plusBtn && E.plusBtn.addEventListener('click', () => E.fileInput && E.fileInput.click());
      E.fileInput && E.fileInput.addEventListener('change', H.handleFileChange);

      E.closeContactBtn && E.closeContactBtn.addEventListener('click', H.closeContactModal);
      E.contactModal && E.contactModal.addEventListener('click', (e) => H.handleModalClick.call(H, e));
      E.generatePlanBtn && E.generatePlanBtn.addEventListener('click', H.openContactModal);
      E.copyAndGoIherbBtn && E.copyAndGoIherbBtn.addEventListener('click', H.handleIherbCopy);
      E.iherbCode && E.iherbCode.addEventListener('click', () => H.handleIherbCodeClick.call(H));
      E.chatAvatar && E.chatAvatar.addEventListener('click', H.openProfileModal);
      E.closeProfileBtn && E.closeProfileBtn.addEventListener('click', H.closeProfileModal);
      E.profileModal && E.profileModal.addEventListener('click', (e) => H.handleModalClick.call(H, e));
      E.profileGetPlanBtn && E.profileGetPlanBtn.addEventListener('click', () => H.handleProfileGetPlanClick.call(H));
      E.resetBtn && E.resetBtn.addEventListener('click', H.handleResetClick);
      E.confirmResetBtn && E.confirmResetBtn.addEventListener('click', H.handleResetConfirm);
      E.cancelResetBtn && E.cancelResetBtn.addEventListener('click', H.handleResetCancel);
      E.resetConfirmModal && E.resetConfirmModal.addEventListener('click', (e) => H.handleModalClick.call(H, e));
      E.messageContextMenu && E.messageContextMenu.addEventListener('click', (e) => {
        const action = e.target.closest('[data-action]')?.dataset.action;
        if (action) H.handleContextMenuAction.call(H, action);
      });
      document.addEventListener('click', (e) => {
        if (E.messageContextMenu && E.messageContextMenu.classList.contains('show') &&
            !E.messageContextMenu.contains(e.target) && !e.target.closest('.message-bubble')) {
          H.hideContextMenu.call(H);
        }
      });
      E.unpinBtn && E.unpinBtn.addEventListener('click', H.handleUnpin);
      E.pinnedMessageArea && E.pinnedMessageArea.addEventListener('click', (e) => {
      ...
      document.querySelectorAll('.lang-toggle-btn').forEach(btn => {
        btn.addEventListener('click', () => this.i18n.setLang(this.state.lang === 'ar' ? 'en' : 'ar'));
      });

      ['pointerdown', 'touchstart'].forEach(ev => E.micBtn && E.micBtn.addEventListener(ev, H.handleMicRecord, { passive: false }));
      ['pointerup', 'touchend', 'mouseleave'].forEach(ev => E.micBtn && E.micBtn.addEventListener(ev, H.handleMicStop, { passive: false }));

      E.closeImageViewerBtn && E.closeImageViewerBtn.addEventListener('click', H.closeImageViewer);
      E.imageViewerModal && E.imageViewerModal.addEventListener('click', (e) => H.handleModalClick.call(H, e));
      E.howToUseLink && E.howToUseLink.addEventListener('click', (e) => { e.preventDefault(); H.openHowToUseModal(); });
      E.closeHowToUseBtn && E.closeHowToUseBtn.addEventListener('click', H.closeHowToUseModal);
      E.howToUseModal && E.howToUseModal.addEventListener('click', (e) => H.handleModalClick.call(H, e));
